...
export const PLAN_LIMITS = {
  ...
  PRO: { maxQR: -1, maxDynamic: 50, maxScans: 10000, features: ['analytics', 'utm', 'svg', 'no-brand', 'logo'] },
  BUSINESS: { maxQR: -1, maxDynamic: -1, maxScans: 100000, features: ['analytics', 'utm', 'svg', 'no-brand', 'logo', 'routing', 'ab-test', 'restaurant', 'bulk', 'security'] },
  AGENCY: { maxQR: -1, maxDynamic: -1, maxScans: 500000, features: ['analytics', 'utm', 'svg', 'no-brand', 'logo', 'routing', 'ab-test', 'restaurant', 'bulk', 'security', 'white-label', 'api', 'clients'] },
