  ...
  return (
    <div style={{ animation: 'fadeUp .5s ease both' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 800, letterSpacing: '-.03em', color: '#111' }}>🍽️ Restaurant Mode</h1>
          <p style={{ fontSize: 13, color: '#9A9A90', marginTop: 4 }}>Menu builder, table QR, and order management</p>
        </div>
      </div>
      <div style={{ background: '#fff', border: '1px solid #E9E8E4', borderRadius: 16, padding: '48px 32px', textAlign: 'center' }}>
        <div style={{ fontSize: 48, marginBottom: 12 }}>🍽️</div>
        <h3 style={{ fontSize: 18, fontWeight: 800, color: '#111', marginBottom: 6 }}>Restaurant Mode</h3>
        <p style={{ fontSize: 13, color: '#9A9A90', maxWidth: 400, margin: '0 auto 20px', lineHeight: 1.6 }}>Menu builder, table QR, and order management. Upgrade to access this feature.</p>
