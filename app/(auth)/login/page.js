      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="card p-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-brand-border bg-white text-sm font-bold text-brand-text cursor-pointer transition-all hover:border-brand-border-focus hover:bg-brand-card-alt mb-4"
          >
          ...
          <div className="flex items-center gap-3 my-4">
            ...
            <span className="text-xs text-brand-text-ghost font-semibold">OR</span>
            <div className="flex-1 h-px bg-brand-border" />
          </div>
        ...
        <p className="text-center text-sm text-brand-text-dim mt-4">
          Don&apos;t have an account?{' '}
          <Link href="/auth/register" className="text-brand-mint-dark font-bold no-underline">Sign up free →</Link>
        </p>
      </div>
    </div>
  );
